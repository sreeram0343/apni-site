    ...
    <div className="bg-white rounded-2xl p-8 sm:p-10 shadow-card border border-slate-100 animate-fade-in text-slate-900">
      ...
      <div className="space-y-6">
        <button
          ...
          disabled={isPending}
          className="flex w-full items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white py-3.5 px-4 text-sm font-bold text-slate-700 shadow-soft hover:bg-slate-50 hover:text-slate-900 transition-all disabled:opacity-50 cursor-pointer"
        >
          {isPending ? (
